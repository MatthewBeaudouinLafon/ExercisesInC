...
int SEGFAULT = 0;
// When set to 1, all clients close after knock knock.
...
void *kk_dialogue(void *pconnect_d) {
    char buf[255];
    char intro_msg[] = "Internet Knock-Knock Protocol Server\nKnock, knock.\n";

    int connect_d = *((int*) pconnect_d);
...
int main(int argc, char *argv[])
{
    ...
    while (1) {
        ...
        pthread_t tid;
        pthread_create(&tid, NULL, kk_dialogue, (void*) &connect_d);
    }
